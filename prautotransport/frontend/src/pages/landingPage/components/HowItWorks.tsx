  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-[1135px] py-4 px-6 flex border border-[#DDE2EC] items-center justify-center rounded-2xl mt-12 text-center shadow-sm bg-[#F4F6FA]/50 mx-4">
        <p className="text-[15px] md:text-[16px] font-instrument text-[#5A6070]">
          Tiempo promedio de proceso: <span className="font-semibold text-[#003087]">6–18 días</span> según origen y destino
        </p>
      </div>
    </div>
  );
